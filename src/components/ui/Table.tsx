...
function Table({ className, ...props }: React.ComponentProps<"table">) {
  return (
    <div data-slot="table-container" className="block w-fit max-w-full overflow-x-auto">
      <table data-slot="table" className={cn("min-w-max caption-bottom text-sm", className)} {...props} />
    </div>
  );
}
